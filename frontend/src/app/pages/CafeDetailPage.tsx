...
import { MapPin, Clock, Heart, Phone, Globe, Calendar, Star } from "lucide-react";

const mockCafeDetail = {
  id: "1",
  name: "카페 메이드 서울",
  description: "서울 최고의 메이드 카페입니다. 친절한 메이드들이 여러분을 맞이합니다.",
  coverImage: "https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=1200",
  location: "서울 강남구 테헤란로 123",
  phone: "02-1234-5678",
  website: "www.cafemaid.com",
  rating: 4.8,
  isOpen: true,
  openingHours: "11:00 - 22:00",
  menus: [
    { id: "1", name: "딸기 파르페", price: 8000, image: "https://images.unsplash.com/photo-1563805042-7684c019e1cb?w=400" },
    { id: "2", name: "오므라이스", price: 12000, image: "https://images.unsplash.com/photo-1513442542250-854d436a73f2?w=400" },
    { id: "3", name: "메이드 특제 음료", price: 6000, image: "https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=400" },
    { id: "4", name: "케이크 세트", price: 15000, image: "https://images.unsplash.com/photo-1578985545062-69928b1d9587?w=400" },
  ],
  schedule: [
  ...
  maidFeeds: [
    {
      id: "1",
      maidName: "사쿠라",
      maidAvatar: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=100",
    ...
    },
    {
      id: "2",
      maidName: "미유",
      maidAvatar: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=100",
        ...
        <div className="absolute bottom-0 left-0 right-0 p-8 text-white">
          <div className="container mx-auto">
            ...
            <div className="flex items-center gap-4 text-lg">
              ...
              <Badge variant={mockCafeDetail.isOpen ? "default" : "destructive"} className="text-sm">
                    ...
                    <div className="space-y-4">
                      {mockCafeDetail.schedule.map((day) => (
                        <div key={day.date} className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                          <span className="font-medium">{new Date(day.date).toLocaleDateString('ko-KR', { month: 'long', day: 'numeric', weekday: 'short' })}</span>
                    ...
                    <Card key={feed.id}>
                      <CardHeader>
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <CardTitle className="text-lg">{feed.maidName}</CardTitle>
